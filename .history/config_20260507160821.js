...
const MARKERS = [
  ...
  { name: 'Bridge',           lat: 52.335578, lng: 5.540539 },
  { name: 'Stone Fence',      lat: 52.335988, lng: 5.537169 },
  { name: 'PostNL letterbox', lat: 52.335569, lng: 5.535894 },
  { name: 'Red Dome',         lat: 52.334416, lng: 5.534418 },
  { name: 'Silver Bench',     lat: 52.334124, lng: 5.536303 }, 
  { name: 'School',           lat: 52.333265, lng: 5.536561 },
];

// ── STAGE 2 BINGO ──────────────────────────────────────────────
// Left column = object names (must stay in sync with MARKERS array above)
const BINGO_LEFT  = ['Tree','SCHOOL','BENCH','GATE','FOUNTAIN','BRIDGE','STATUE','SIGN'];
